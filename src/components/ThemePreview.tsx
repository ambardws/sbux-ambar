            ...
            <div className="flex flex-col gap-3 md:flex-row">
              <div className="md:w-1/2">
                ...
                <div className="flex flex-col">
                  <span className="link">a simple link</span>
                  <span className="link link-primary">a simple link</span>
                  <span className="link link-secondary">a simple link</span>
                  <span className="link link-accent">a simple link</span>
                </div>
              </div>
